...
# =============================================================================
# 🕐 FUNÇÕES EXTRAS PARA 96% DE PRECISÃO
# =============================================================================
...
def calcular_previsao():
    ...
    bonus_semanal = analisar_padroes_semanais()
    virada = detectar_virada_mesa()
...
# =============================================================================
# SISTEMA DE APRENDIZADO - ATUALIZADO
# =============================================================================
def verificar_previsoes_anteriores():
    if cache.get('ultima_previsao') and cache.get('ultimo_resultado_real'):
        ...
        for estrategia in ultima.get('estrategias', []):
            # Limpa nome (remove emojis e espaços)
            nome_clean = estrategia.replace('🔴', '').replace('🔵', '').replace('🟡', '').strip().split(' ')[0]
            
            # Mapeia nomes para o dicionário
            mapeamento = {
